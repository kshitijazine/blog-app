...
class _ReachUsState extends State<ReachUs> {
  ...
  _launchURLMail() async {
    const url =
        'mailto:kshitija@example.org?subject=LifePlusApp&body=Your sugestions%20or Feedback..';
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                "Leave us message and we'll get in contact with you as soon as possible. ",
                style: TextStyle(
                  fontSize: 17.5,
                  height: 1.3,
              ...
              child: GestureDetector(
                onTap: () {
                  setState(() {
                    ...
                    t2.clear();
                    launchUrl(
                        "mailto:kshitijazine@gmail.com?subject=From $name&body=$message");
                  });
                },
                child: ListTile(
                  title: Row(
            ...
            Padding(
              ...
              child: Text(
                "Alternatively, you can also report bugs and errors on following platform",
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontFamily: 'RobotoSlab',
            ...
            Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () => launchUrl("https://github.com/kshitijazine"),
                  child: Icon(
